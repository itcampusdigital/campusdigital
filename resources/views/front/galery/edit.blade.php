...
<section>
  <div class="container lg-3">
    <div class="row">
        ...
        <form enctype="multipart/form-data" method="POST" action="{{ route('galery.update',$gambar->id) }}" >
            {{ csrf_field() }}

            <div class="form-group">
              <label for="judul_gambar">Judul Gambar</label>
              <input type="text" name="judul_gambar" class="form-control mb-4" value="{{ $gambar->judul_gambar }}">
            </div>
            <div class="form-group">
