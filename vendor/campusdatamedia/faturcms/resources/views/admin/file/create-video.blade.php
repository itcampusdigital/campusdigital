                ...
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.file.store', ['kategori' => $kategori->slug_kategori]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="file_deskripsi" class="form-control {{ $errors->has('file_deskripsi') ? 'is-invalid' : '' }}" rows="3">{{ old('file_deskripsi') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="file_konten" class="form-control {{ $errors->has('file_konten') ? 'is-invalid' : '' }}" value="{{ old('file_konten') }}">
