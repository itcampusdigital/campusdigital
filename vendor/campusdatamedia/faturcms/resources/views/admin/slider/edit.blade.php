    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.slider.update') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <br>
                                <img src="{{ image('assets/images/slider/'.$slider->slider, 'slider') }}" id="img-file" class="mt-2 img-thumbnail {{ $slider->slider != '' ? '' : 'd-none' }}" style="max-height: 150px">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="url" class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" value="{{ $slider->slider_url }}">
                                @if($errors->has('url'))
