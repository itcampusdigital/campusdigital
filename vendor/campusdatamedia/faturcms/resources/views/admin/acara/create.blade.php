    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.acara.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Nama Acara <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <input type="text" name="nama_acara" class="form-control {{ $errors->has('nama_acara') ? 'is-invalid' : '' }}" value="{{ old('nama_acara') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="tempat_acara" class="form-control {{ $errors->has('tempat_acara') ? 'is-invalid' : '' }}" value="{{ old('tempat_acara') }}">
