    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.mentor.update') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="nama_mentor" class="form-control {{ $errors->has('nama_mentor') ? 'is-invalid' : '' }}" value="{{ $mentor->nama_mentor }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="profesi_mentor" class="form-control {{ $errors->has('profesi_mentor') ? 'is-invalid' : '' }}" value="{{ $mentor->profesi_mentor }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <br>
                                <img src="{{ image('assets/images/mentor/'.$mentor->foto_mentor, 'mentor') }}" id="img-file" class="mt-2 img-thumbnail {{ $mentor->foto_mentor != '' ? '' : 'd-none' }}" style="max-height: 150px">
