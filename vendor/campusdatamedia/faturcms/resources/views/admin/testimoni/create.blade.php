    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.testimoni.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Nama Klien <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <input type="text" name="nama_klien" class="form-control {{ $errors->has('nama_klien') ? 'is-invalid' : '' }}" value="{{ old('nama_klien') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="profesi_klien" class="form-control {{ $errors->has('profesi_klien') ? 'is-invalid' : '' }}" value="{{ old('profesi_klien') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="testimoni" class="form-control {{ $errors->has('testimoni') ? 'is-invalid' : '' }}">{{ old('testimoni') }}</textarea>
