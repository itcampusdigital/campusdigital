                    ...
                    <form id="form" method="post" action="{{ route('admin.setting.update', ['category' => $kategori->slug]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <br>
                                <img src="{{ asset('assets/images/icon/'.setting('site.icon')) }}" id="img-file" class="mt-2 img-thumbnail" style="max-height: 150px">
...
@include('faturcms::template.admin._js-image', ['imageType' => 'icon', 'croppieWidth' => 300, 'croppieHeight' => 300])
