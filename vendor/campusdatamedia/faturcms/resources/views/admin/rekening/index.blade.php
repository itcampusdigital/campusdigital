        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                ...
                <div class="tile-title-w-btn">
                    <div class="btn-group">
                        <a href="{{ route('admin.rekening.create') }}" class="btn btn-sm btn-theme-1"><i class="fa fa-plus mr-2"></i> Tambah Data</a>
                    </div>
                </div>
                <!-- /Tile Title -->
                <!-- Tile Body -->
                <div class="tile-body">
                    ...
                    <div class="table-responsive">
                        <table id="dataTable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('admin.rekening.edit', ['id' => $data->id_rekening]) }}" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                        ...
                        <form id="form-delete" class="d-none" method="post" action="{{ route('admin.rekening.delete') }}">
                            {{ csrf_field() }}
