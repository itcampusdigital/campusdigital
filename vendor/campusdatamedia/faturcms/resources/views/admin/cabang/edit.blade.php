    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.cabang.update') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="nama_cabang" class="form-control {{ $errors->has('nama_cabang') ? 'is-invalid' : '' }}" value="{{ $cabang->nama_cabang }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="alamat_cabang" class="form-control {{ $errors->has('alamat_cabang') ? 'is-invalid' : '' }}" rows="3">{{ $cabang->alamat_cabang }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="nomor_telepon_cabang" class="form-control {{ $errors->has('nomor_telepon_cabang') ? 'is-invalid' : '' }}" value="{{ $cabang->nomor_telepon_cabang }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="instagram_cabang" class="form-control {{ $errors->has('instagram_cabang') ? 'is-invalid' : '' }}" value="{{ $cabang->instagram_cabang }}">
