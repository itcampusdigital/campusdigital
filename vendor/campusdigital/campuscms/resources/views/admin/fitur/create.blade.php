    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.fitur.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Nama Fitur <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <input type="text" name="nama_fitur" class="form-control {{ $errors->has('nama_fitur') ? 'is-invalid' : '' }}" value="{{ old('nama_fitur') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="deskripsi_fitur" class="form-control {{ $errors->has('deskripsi_fitur') ? 'is-invalid' : '' }}">{{ old('deskripsi_fitur') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="url_fitur" class="form-control {{ $errors->has('url_fitur') ? 'is-invalid' : '' }}" value="{{ old('url_fitur') }}">
