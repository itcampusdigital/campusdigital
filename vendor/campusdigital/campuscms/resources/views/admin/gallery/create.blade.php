                ...
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.gallery.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="judul_gambar" class="form-control {{ $errors->has('judul_gambar') ? 'is-invalid' : '' }}" value="{{ old('judul_gambar') }}">
...
@include('faturcms::template.admin._modal-image', ['croppieWidth' => 1080, 'croppieHeight' => 1080])

@endsection

@section('js-extra')

@include('faturcms::template.admin._js-image', ['imageType' => 'mentor', 'croppieWidth' => 1080, 'croppieHeight' => 1080])
