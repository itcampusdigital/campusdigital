    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.platform.update') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $platform->id_platform }}">
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Nama Platform <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <input type="text" name="nama_platform" class="form-control {{ $errors->has('nama_platform') ? 'is-invalid' : '' }}" value="{{ $platform->nama_platform }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="tipe_platform" id="tipe-1" value="1" {{ $platform->tipe_platform == '1' ? 'checked' : '' }}>
                                  <label class="form-check-label" for="tipe-1">Bank</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="tipe_platform" id="tipe-2" value="2" {{ $platform->tipe_platform == '2' ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="kode_platform" class="form-control {{ $errors->has('kode_platform') ? 'is-invalid' : '' }}" value="{{ $platform->kode_platform }}">
