    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.halaman.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Judul Halaman <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <input type="text" name="judul_halaman" class="form-control {{ $errors->has('judul_halaman') ? 'is-invalid' : '' }}" value="{{ old('judul_halaman') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="tipe" id="tipe-1" value="1" {{ old('tipe') == '1' ? 'checked' : '' }} {{ old('tipe') == null ? 'checked' : '' }}>
                                  <label class="form-check-label" for="tipe-1">{{ tipe_halaman(1) }} <em>(Tampilan berdasarkan Quill Editor)</em></label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="tipe" id="tipe-2" value="2" {{ old('tipe') == '2' ? 'checked' : '' }}>
                        ...
                        <div class="form-group row form-konten d-none" data-tipe="2">
                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="view" class="form-control {{ $errors->has('view') ? 'is-invalid' : '' }}" value="{{ old('view') }}">
