                ...
                <div class="tile-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="form" method="post" action="{{ route('admin.signature.update') }}" class="d-none">
                                        {{ csrf_field() }}
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <form id="form-2" method="post" action="{{ route('admin.signature.update') }}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
