...
@section('title', 'Tambah Kategori User')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.user.kategori.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
