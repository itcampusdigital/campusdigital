    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.pelatihan.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Nama Pelatihan <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <input type="text" name="nama_pelatihan" class="form-control {{ $errors->has('nama_pelatihan') ? 'is-invalid' : '' }}" value="{{ old('nama_pelatihan') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="tempat_pelatihan" class="form-control {{ $errors->has('tempat_pelatihan') ? 'is-invalid' : '' }}" value="{{ old('tempat_pelatihan') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="fee" class="form-control {{ $errors->has('fee') ? 'is-invalid' : '' }} number-only thousand-format" value="{{ old('fee') }}">
                                </div>
                                @if($errors->has('fee'))
