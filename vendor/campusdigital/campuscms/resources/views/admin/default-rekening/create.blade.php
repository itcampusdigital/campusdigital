...
@section('title', 'Tambah Default Rekening')
...
<main class="app-content">
    ...
    @include('faturcms::template.admin._breadcrumb', ['breadcrumb' => [
        'title' => 'Tambah Default Rekening',
        'items' => [
            ['text' => 'Default Rekening', 'url' => route('admin.default-rekening.index')],
            ['text' => 'Tambah Default Rekening', 'url' => '#'],
        ]
    ]])
    <!-- /Breadcrumb -->
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.default-rekening.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
