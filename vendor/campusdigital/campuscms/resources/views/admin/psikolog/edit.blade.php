    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.psikolog.update') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $psikolog->id_psikolog }}">
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Nama <span class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <input type="text" name="nama_psikolog" class="form-control {{ $errors->has('nama_psikolog') ? 'is-invalid' : '' }}" value="{{ $psikolog->nama_psikolog }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select name="kategori_psikolog" class="form-control {{ $errors->has('kategori_psikolog') ? 'is-invalid' : '' }}" >
                                    ...
                                    <option value="1" {{ $psikolog->kategori_psikolog == 1 ? 'selected' : '' }}>{{ psikolog(1) }}</option>
                                    <option value="2" {{ $psikolog->kategori_psikolog == 2 ? 'selected' : '' }}>{{ psikolog(2) }}</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="kode_psikolog" class="form-control {{ $errors->has('kode_psikolog') ? 'is-invalid' : '' }}" value="{{ $psikolog->kode_psikolog }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="alamat_psikolog" class="form-control {{ $errors->has('alamat_psikolog') ? 'is-invalid' : '' }}" rows="3">{{ $psikolog->alamat_psikolog }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="nomor_telepon_psikolog" class="form-control {{ $errors->has('nomor_telepon_psikolog') ? 'is-invalid' : '' }}" value="{{ $psikolog->nomor_telepon_psikolog }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="instagram_psikolog" class="form-control {{ $errors->has('instagram_psikolog') ? 'is-invalid' : '' }}" value="{{ $psikolog->instagram_psikolog }}">
