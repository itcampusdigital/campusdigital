...
<main class="app-content">
    ...
    @include('faturcms::template.admin._breadcrumb', ['breadcrumb' => [
        ...
        'items' => [
            ...
            ['text' => 'Edit Kategori Program', 'url' => '#'],
        ]
    ]])
    <!-- /Breadcrumb -->
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <!-- Tile Body -->
                <div class="tile-body">
                    <form id="form" method="post" action="{{ route('admin.program.kategori.update') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $kategori->id_kp }}">
