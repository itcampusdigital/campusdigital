                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 order-1 order-lg-2 mb-4 mb-lg-0" style="border-left: 1px solid #bebebe;">
                            ...
                            <div class="list-group list-group-flush">
                                ...
                                <a class="list-group-item list-group-item-action p-1 {{ $file->id_file == $data->id_file ? 'active' : '' }}" href="{{ route('member.file.detail', ['kategori' => $kategori->slug_kategori, 'id' => $data->id_file]) }}">
                                    {{ $data->file_nama }}
                                </a>
                                @endforeach
                            </div>
